...
document.ontouchstart = evt => birthday.onClick(evt)
  ...
  document.addEventListener("DOMContentLoaded", function () {
      ...
      document.querySelector(".link2").addEventListener("click", function () {
          window.location.href = "page3.html"; // Ensure this page exists
      });
  });
  // ✅ Add this at the end
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector(".link3").addEventListener("click", function () {
        window.location.href = "page4.html"; // Ensure this page exists
    });
});
// ✅ Add this at the end
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelector(".link4").addEventListener("click", function () {
      window.location.href = "page5.html"; // Ensure this page exists
  });
});
// ✅ Add this at the end
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelector(".link1").addEventListener("click", function () {
      window.location.href = "page2.html"; // Ensure this page exists
  });
});
// ✅ Add this at the end
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelector(".link5").addEventListener("click", function () {
      window.location.href = "page7.html"; // Ensure this page exists
  });
});
